							...
							<div class='animated flipInX col-md-4'>
								<div class='box box-solid direct-chat direct-chat-warning'>
									<div class='box-header with-border'>
										...
										<div class='box-tools pull-right'>
											<a href='?pg=&ac=clearlog' class='btn btn-sm btn-flat bg-maroon' title='Bersihkan Log'><i class='fa fa-trash-o'></i></a>
										</div>
									</div><!-- /.box-header -->
									<div class='box-body'>
										<div id='log-list'>
												...
												<?php while ($pengawas = mysql_fetch_array($guruku)) : ?>
													...
													<tr>
														...
														<td style="text-align:center">
															<div class='btn-group'>
																<a href="?pg=guru&ac=edit&id=<?= $pengawas['id_pengawas'] ?>"> <button class='btn btn-flat btn-xs btn-warning'><i class='fa fa-pencil-square-o'></i></button></a>
																<a href="?pg=guru&ac=hapus&id=<?= $pengawas['id_pengawas'] ?>"> <button class='btn btn-flat btn-xs bg-maroon'><i class='fa fa-trash-o'></i></button></a>
															</div>
														</td>
													</tr>
												<?php endwhile ?>
							...
							if ($filename != '') {
								if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
									if (move_uploaded_file($_FILES['file']['tmp_name'], $uploadfile)) {
										...
										echo "<script>
												window.alert('Gagal Tambahkan Berkas.');
											</script>";
									}
								} else {
									echo "<script>
												window.alert('EKSTENSI FILE YANG DI UPLOAD TIDAK DI PERBOLEHKAN');
											</script>";
								}
							}
						}
